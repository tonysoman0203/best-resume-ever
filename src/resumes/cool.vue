      ...
      <div class="content__left">
        ...
        <div
         ...
         <div class="section">
          ...
          <span class="section-content section-content--plain">{{ person.salary }} But Negotiable </span>
        </div>
        <div class="section">
          <div class="section-headline">
            <i class="section-link__icon material-icons">work</i>{{lang.available}}
          </div>
          <span class="section-content section-content--plain">{{ person.available }} </span>
        </div>
